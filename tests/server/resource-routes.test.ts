...
const newRouteFiles = [
  ...
  'server/api/admin/assets/[assetUuid]/preview.post.ts',
  'server/api/admin/assets/drafts/index.post.ts',
  'server/api/admin/assets/drafts/from-asset/[assetUuid].post.ts',
  'server/api/admin/assets/drafts/[draftId].delete.ts',
  'server/api/admin/assets/drafts/[draftId]/commit.post.ts',
  'server/api/admin/assets/drafts/[draftId]/renders/index.post.ts',
  'server/api/admin/assets/drafts/[draftId]/renders/[renderId].get.ts',
...
const removedRouteFiles = [
  ...
  // Variants are made from drafts now, which are staged once.
