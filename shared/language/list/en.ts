...
export default defineI18nBase({
  ...
  phrases: {
    ...
    update_site_closed:
      'The site is closed until the update is finished; visitors meanwhile ' +
      'see that it is temporarily unavailable.',
    update_waiting: 'Waiting for the site to come back…',
    update_unavailable_title: 'The site is temporarily unavailable',
    update_unavailable_note:
      'Maintenance is under way. This page will open the site by itself as soon as it is back.',
    ...
    page_slug: 'Page slug',
    page_slug_hint:
      'A unique URL-safe path using lowercase letters, numbers, and hyphens.',
    page_link_example: (slug) => `Final link: /pages/${slug}/`,
    page_slug_invalid: 'Use lowercase letters, numbers, and hyphens.',
    ...
    content_spoiler_reveal: 'Hidden; open to read',
    content_link_note: 'Why this link is here',
    content_link_note_placeholder: 'A note for the link',
