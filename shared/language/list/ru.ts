...
export default defineI18nModule({
  ...
  phrases: {
    ...
    project_stage_private_hint: 'Виден только вам в админ-панели.',
    project_stage_period: 'Временные промежутки',
    project_stage_period_required: 'Укажите временной промежуток этапа.',
    ...
    content_section_summary: 'Краткое описание раздела',
    content_section_private: 'Приватный раздел',
    content_section_private_hint: 'Виден только вам в админ-панели.',
    ...
    content_section_content_required:
      'Добавьте хотя бы один содержательный блок.',
