...
export default defineI18nModule({
  ...
  phrases: {
    ...
    content_gallery_caption: 'Подпись к галерее',
    content_title: 'Название',
    content_description: 'Описание',
    content_remove: 'Убрать',
    ...
    showcase_caption_hint: 'Описание фаайла',
    ...
    upload_section_original: 'Оригинал',
    upload_section_existing: 'Уже загружено',
    upload_section_edit: 'Изменить',
    upload_section_zip: 'Архив',
    upload_use: 'Использовать',
    upload_show_original: 'Показать оригинал',
    upload_upload_original: 'Загрузить оригинал',
    upload_uploading_original: 'Загрузка оригинала...',
    upload_saving: 'Сохранение...',
    upload_searching: 'Ищу...',
    upload_no_matches: 'Совпадений пока нет',
    upload_apply_settings: 'Применить настройки',
    ...
    upload_strip_audio: 'Вырезать аудио?',
    upload_fast_conversion: 'Быстрое преобразование?',
    ...
    upload_error_original: 'Не удалось загрузить оригинал.',
    ...
    file_info_archived_extension: 'Исходное расширение',
    file_info_archived_size: 'Исходный размер',
    file_hash_failed: 'Не удалось рассчитать хэш файла.',
    file_hash_calculating: 'Вычисление хэша файла',
  },
});
