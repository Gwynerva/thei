...
export type LanguagePhrases = {
  ...
  upload_section_original: string;
  upload_section_existing: string;
  upload_section_edit: string;
  upload_section_zip: string;
  upload_use: string;
  upload_show_original: string;
  upload_upload_original: string;
  upload_uploading_original: string;
  ...
  file_hash_failed: string;
  file_hash_calculating: string;
};
