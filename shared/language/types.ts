...
export type LanguagePhrases = {
  ...
  public_projects_description: string;
  ...
  public_details_links_content: string;
  public_details_files_content: string;
  ...
  update_phase_preparing: string;
  update_phase_dependencies: string;
  update_phase_building: string;
  update_phase_swapping: string;
  update_phase_restarting: string;
  update_phase_done: string;
  update_phase_failed: string;
  ...
  public_projects_empty: string;
  public_projects_empty_description: string;
  ...
  project_portfolio_badge: string;
  project_portfolio_badge_hint: string;
