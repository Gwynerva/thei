...
/**
 * Entities as named chips, for a list that is about them — the projects of a
 * year under the activity heatmap. A card's own related entities use the
 * quieter `PublicEntityLinks` instead.
 */
defineProps<{ projects: PublicEntityLink[] }>();
</script>
